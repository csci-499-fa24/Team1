...
export default function SignUp() {
    ...
    return (
        <div className={styles.background}>
            ...
            <form id="form" className={styles.formContainer} onSubmit={handleSubmit}>
                <div>
                <label htmlFor="firstname-input" className={styles.label}>
                    <svg
                ...
                <div>
                <label htmlFor="repeat-password-input" className={styles.label}>
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="24"
                    viewBox="0 -960 960 960"
